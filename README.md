...
- `configs/north-fp8-speculators-rocky-portability-v1.json` — Rocky TP=2 FP8 acceptance, actual target-only speedup, concurrency, and long-context evidence
