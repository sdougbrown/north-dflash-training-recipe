...
- `configs/north-fp8-speculators-code-scaling-v1.json` — 500/1,000/2,000/5,000-row on-policy scaling and fixed held-out acceptance evidence
- `configs/north-fp8-speculators-rocky-portability-v1.json` — Rocky TP=2 FP8 eager portability, acceptance, concurrency, and long-context evidence
- `configs/north-fp8-speculators-rocky-compiled-runtime-v1.json` — matched compiled target-only/DFlash gate and runtime proposal/attention sweep
